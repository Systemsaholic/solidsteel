...
const service = getServiceBySlug("steel-construction")!
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-blue-700 mb-4">
                Commercial &amp; Industrial Steel Buildings in Ontario
              </h2>
            ...
            <div>
              <div className="bg-gray-50 rounded-lg p-6 sm:p-8">
                <h3 className="text-lg sm:text-xl font-semibold mb-4">Steel Building Advantages</h3>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto text-sm sm:text-base leading-relaxed">
              End-to-end steel building capabilities from foundation to finished facility.
            </p>
          </div>
