...
const service = getServiceBySlug("pre-engineered-buildings")!
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-blue-700 mb-4">
                Factory-Engineered Buildings for Ontario &amp; Canada
              </h2>
            ...
            <div>
              <div className="bg-gray-50 rounded-lg p-6 sm:p-8">
                <h3 className="text-lg sm:text-xl font-semibold mb-4">PEB Advantages</h3>
      ...
      <section className="py-16 md:py-24 bg-gray-100">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-blue-700 mb-4">
              Complete PEB Services
            </h2>
            <p className="text-gray-600 max-w-3xl mx-auto text-sm sm:text-base leading-relaxed">
              From building selection through occupancy — everything you need for a successful pre-engineered building project.
            </p>
          </div>
